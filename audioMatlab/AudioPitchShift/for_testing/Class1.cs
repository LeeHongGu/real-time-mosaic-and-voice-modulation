...
namespace AudioPitchShift
{
  ...
  public class Class1 : IDisposable
  {
    ...
    /// <summary>
    /// Provides a void output, 0-input MWArrayinterface to the AudioPitchShift MATLAB
    /// function.
    /// </summary>
    /// <remarks>
    /// M-Documentation:
    ...
    {
      mcr.EvaluateFunction(0, "AudioPitchShift", new MWArray[]{});
    }


    /// <summary>
    /// Provides a void output, 1-input MWArrayinterface to the AudioPitchShift MATLAB
    /// function.
    /// </summary>
    /// <remarks>
    /// M-Documentation:
    ...
    ///
    public void AudioPitchShift(MWArray shift_val)
    {
    ...
    /// <summary>
    /// Provides the standard 0-input MWArray interface to the AudioPitchShift MATLAB
    /// function.
    /// </summary>
    /// <remarks>
    /// M-Documentation:
    ...
    /// arguments.</returns>
    ///
    public MWArray[] AudioPitchShift(int numArgsOut)
    {
      return mcr.EvaluateFunction(numArgsOut, "AudioPitchShift", new MWArray[]{});
    }


    /// <summary>
    /// Provides the standard 1-input MWArray interface to the AudioPitchShift MATLAB
    /// function.
    /// </summary>
    /// <remarks>
    /// M-Documentation:
    ...
    /// arguments.</returns>
    ///
    public MWArray[] AudioPitchShift(int numArgsOut, MWArray shift_val)
    {
