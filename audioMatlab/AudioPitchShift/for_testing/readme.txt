AudioPitchShift MATLAB .NET Assembly (.NET Component)
...
AudioPitchShift_overview.html - HTML overview documentation file for the generated 
                                component. It contains the requirements for accessing the 
                                component and for generating arguments using the MWArray 
                                class hierarchy.

AudioPitchShift.xml - This file contains the code comments for the AudioPitchShift 
                                ...
                                documentation for the AudioPitchShift component.
